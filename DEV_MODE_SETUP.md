...
## Решение: Включить DEV MODE на API

### 1. Зайди в Render (API)

URL: https://render.com/

Найди сервис: `tr1h/huma-chain-xyz` (API)

### 2. Удали или закомментируй `BOT_TOKEN`
...
Render автоматически перезапустит API.
...
- ⚠️ Можно изменить `user_id` в URL (но это не критично для игры)
...
## Альтернатива: Dual Mode

Можно добавить отдельный env variable для контроля:
