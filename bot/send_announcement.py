...
# Group IDs
GROUP_ID = int(os.getenv('GROUP_ID', '-1002938566588'))  # @gotchigamechat
CHANNEL_ID = os.getenv('CHANNEL_USERNAME', 'GotchiGame')  # Channel username

def send_group_announcement():
    """Send announcement to group"""
    group_text = f"""🎉 *GAMIFICATION IS LIVE!* 🎉
...
def send_channel_announcement():
    ...
    channel_text = f"""🎮 *MAJOR UPDATE: GAMIFICATION SYSTEM LIVE!* 🎮
