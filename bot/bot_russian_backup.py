...
# URLs
GAME_URL = os.getenv('GAME_URL', 'https://tr1h.github.io/solana-tamagotchi/')  # Coming Soon Page
MINT_URL = os.getenv('MINT_URL', 'https://tr1h.github.io/solana-tamagotchi/')  # Coming Soon Page
CHANNEL_ID = os.getenv('CHANNEL_USERNAME', 'GotchiGame')
